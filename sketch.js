...
function preload(){
  trex_running =   loadAnimation("Untitled.png","Untitle2.png","Untitled3.png");
  trex_collided = loadAnimation("Untitled4.png");
  
  groundImage = loadImage("ground2-1.png");
  
  cloudImage = loadImage("cl.png");
